...
const new_header = "Date,100003032,100012218,100035408,100004575,100035409,100003041,100041114,100007390,100041101,100034805,100004575,100003032,100001753,100003042,100003040,100002880,100012217,100003034,100011748,100011747,100025474,100017523,100047030"
...
//     console.log(tmp)
    fs.readFile(path.join(__dirname, `../public/csv/counter_stats_2018.csv`), 'utf8', function (err, data) {
        ...
        fs.writeFile(path.join(__dirname, `../public/csv/counter_stats_2018.csv`), result, 'utf8', function (err) {
            ...
            dataStatsModel.create(getData("counter_stats_2018")).then(r => console.log("Data 2018 successful"))
...
// })
    dataStatsModel.create(getData("counter_stats_2019")).then(r => console.log("Data 2019 successful"));
    dataStatsModel.create(getData("counter_stats_2020")).then(r => console.log("Data 2020 successful"));
    dataStatsModel.create(getData("counter_stats_2021")).then(r => console.log("Data 2021 successful"));
}
